...
The Exit Module allows members to redeem a designated token for a proportion of an avatar's (account's) digital assets, similar to Moloch DAO's [rageQuit()](https://twitter.com/molochdao/status/1115451404242436098) function. [Learn more about the Zodiac Exit Pattern](/documentation/exit-pattern).
