...
A group of friends share a multisig that grows beyond expectations. They decide to upgrade the multisig to a multiplayer DAO by equipping the Zodiac Governor Module. By tapping into the most popular on-chain governance framework, the squad can immediately enjoy on-chain voting. Down the line, they can decide to keep things open and modular or, for example, use the full capabilities of the [Tally](https://www.tally.xyz/) platform.
