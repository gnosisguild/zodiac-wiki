---
title: "Zodiac Delay Modifier"
description: "Zodiac Delay Modifier allows an account to enforce a time delay between when a module initiates a transaction and when it can be executed."
---
...
Zodiac Delay Modifier allows avatars (a Safe or other web3 account) to enforce a time delay between when a module initiates a transaction and when it can be executed by an avatar.
