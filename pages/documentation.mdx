...
The expansion pack for DAOs, Zodiac is a collection of tools built according to an [open standard](https://eips.ethereum.org/EIPS/eip-5005). The Zodiac open standard enables DAOs to act more like constellations, connecting protocols, platforms, and chains, no longer confined to monolithic designs.
